...
//       test.getUser();
    ...
    public void insertStage()
    {
        ...
        List<RowsOFStage> ss=new ArrayList();
        ss.add(new RowsOFStage("1 ROW Name"));
        ss.add(new RowsOFStage("2 ROW Name"));
        ss.add(new RowsOFStage("3 ROW Name"));
//        ss.add(new RowsOFStage("4 ROW Name"));
//        ss.add(new RowsOFStage("5 ROW Name"));
//        ss.add(new RowsOFStage("6 ROW Name"));
        
        Stage stage=new Stage();
        stage.setStageName("Secondary Stage");
        stage.setStageYear("2016");
