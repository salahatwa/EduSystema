...
public class Student extends Stuff implements Serializable{
    ...
    private Stage stage;
     ...
     // Student Many-to-one with Stage class 
    @ManyToOne(fetch = FetchType.LAZY, targetEntity = RowsOFStage.class ,cascade = CascadeType.ALL)
    @JoinColumn(name = "row_stage_id")
    private RowsOFStage rowsOFStage;
    ...
    /**
     * @return the rowsOFStage
     */
    public RowsOFStage getRowsOFStage() {
        return rowsOFStage;
    }

    /**
     * @param rowsOFStage the rowsOFStage to set
     */
    public void setRowsOFStage(RowsOFStage rowsOFStage) {
        this.rowsOFStage = rowsOFStage;
    }
